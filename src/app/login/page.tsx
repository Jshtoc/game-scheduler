  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-6 p-8">
      <div className="flex flex-col items-center gap-3">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Game Scheduler</h1>
        <p className="text-zinc-500">게임 일정을 친구들과 함께 관리하세요</p>
      </div>
      ...
      <a
        ...
        className="flex items-center gap-3 rounded-lg bg-[#5865F2] px-6 py-3 font-medium text-white transition-colors hover:bg-[#4752C4]"
      >
